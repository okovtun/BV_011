...
1. Есть массив из 10ти элементов. Необходмо создать еще 2 массива even[] и odd[] минимально возможного размера.
   ...
   Задачу решить в отдельном проекте (Split);
2. В проекте DynamicMemory написать функции:
	??? push_back(???);	//Добавляет значение в конец динамического массива.	DONE
	??? push_front(???);	//Добавляет значение в начало динамического массива.	DONE
	??? insert(???);	//Добавляет значение в массив по указанному индексу.
	??? pop_back(???);	//Удаляет последний элемент массива.			DONE
	??? pop_front(???);	//Удаляет нулевой элемент массива.			DONE
	??? erase(???);		//Удаляет значение из массива по указанному индексу.
   Функции, добавляющие значение в массив увеличивают размер массива на 1 элемент, 
   а функции, удаляющие значение из массива, уменьшают массив на 1 элемент.


TODO:
!!!!!!!!!!!!!!!!!!! ВЫУЧИТЬ КОНПЕКТ ПО УКАЗАТЕЛЯМ !!!!!!!!!!!!!!!!!!!!!!
Максу повторить Операторы C++: https://github.com/okovtun/BV_011/blob/master/DataTypes.pdf
http://cplusplus.com/doc/tutorial/pointers/


DONE:
1. Написать рекурсивную функцию Power, которая принимает основание и показатель степени, и возвращает степень числа;
2. Написать рекурсивную функцию Fibonacci, которая выводит на экран числа из ряда Фибоначчи, до указанного числа;
3. Написать рекурсивную функцию Fibonacci, которая выводит на экран заданное количество чисел из ряда Фибоначчи.
